...
namespace Globals
{
    ...
    public static class ColorManager
    {
        ...
        public static Godot.Collections.Array<Color> Colors { get { return _colors; } }
        ...
        public static float GetValue(int colorId) => ColorsValues[colorId];
        public static int CheckColor(int colorId, int targetColorId) => Convert.ToInt32(colorId == targetColorId);
        public static int CheckColorChanging(int colorId, int targetColorId) => (colorId == targetColorId) ? 1 : -1;
    }
}
