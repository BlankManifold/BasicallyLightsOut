...
namespace DevTools
{
    public partial class PuzzleCreationManager : Managers.NormalModeManager
    {
    ...
    //             public void Init(Managers.NormalModeManager puzzleManager)
    //             {
    ...
    //                 _puzzleDataRes = new PuzzleDataRes();
    //             }
